import { DisplayFormat, FilterCond, FilterItem } from "../model/types";
...
export default class QuickFilter extends Control {
    ...
    constructor(idOrSettings?: string | $QuickFilterSettings);
    constructor(id?: string, settings?: $QuickFilterSettings);
    constructor(id?: string, settings?: $QuickFilterSettings) {
        super(id, settings);
    }
    ...
    setValue(value: string): this {
        if (this._filterControl instanceof DatePicker || this._filterControl instanceof Input) {
            ...
            // the bound filter value for combobox filter has to be set manually, as the change event
            //  is not triggered here
            this.getFilterData().value = value;
        }
        return this;
    }
